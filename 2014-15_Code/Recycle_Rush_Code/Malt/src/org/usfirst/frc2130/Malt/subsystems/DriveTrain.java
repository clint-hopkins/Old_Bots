...
public class DriveTrain extends Subsystem {
    ...
    public void initDefaultCommand() {
        ...
        setDefaultCommand(new DriverDriving());
    ...
    public void fixedMec() {
    	robotDrive41.mecanumDrive_Cartesian(Robot.oi.driver.getRawAxis(0) * 0.6, 
    										Robot.oi.driver.getRawAxis(1) * 0.7, 
    										Robot.oi.driver.getRawAxis(4) * 0.5, 0);
    }
}
