...
public class Elevator extends PIDSubsystem {
    ...
    private final DigitalInput middleProx = RobotMap.elevatorMiddleProx;
    ...
    public boolean middleProxReadings() {
    ...
    public void setWithSaturate(double desiredOutput) {
    	...
    	if (limitedOutput < 0 && middleProxReadings() == true) {
    		limitedOutput = limitedOutput * 0;
    	}
    	if (limitedOutput < 0 && locationDetectionEncoderReadings() > 170) {
    		limitedOutput = limitedOutput * 0.2;
    	}
    ...
    public void saturatedJoystick() {
    	...
    	if(Robot.oi.operator.getRawAxis(1) > 0) {
    		double desiredOuput = Robot.oi.operator.getRawAxis(1)*-0.35;
    		setWithSaturate(desiredOuput);
    	}
    }
}
